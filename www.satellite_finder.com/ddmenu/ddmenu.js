...
function Ddmenu(l) {
    ...
    var r = function(a, b) {
        ...
        if (a.preventDefault)
            ...
            a.returnValue = false
    }, h, d, v, f = document, k = "className", a = "length", A = "addEventListener", lb = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], C = "offsetWidth", D = "zIndex", j = "onclick", b = [], y = -1, o = 0, H = function(a) {
        if (o)
            o[d][v] = a ? "block" : "none"
    }, g, nb, c, i = function() {
        return c && c[C]
        ...
        if (b)
            ...
            J(a, "over");
        a[d][D] = b ? 2 : 1
    }, O = "ontouchstart"in window || window.DocumentTouch && document instanceof DocumentTouch, V = (m.msPointerEnabled || m.pointerEnabled) && (m.msMaxTouchPoints || m.maxTouchPoints);
    if (V)
    ...
    U.prototype = {
        ...
        f: function() {
            x(this.a, 1);
            if (!i() && F(this.a, "position") == "static")
                this.a.dd[d].top = this.a.offsetTop + this.a.offsetHeight + "px";
            else
                this.a.dd[d].top = ""
        },
        g: function() {
